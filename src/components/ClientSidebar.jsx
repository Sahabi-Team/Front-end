    ...
    >
      ...
      <List sx={{ color: "black", width: "100%", top: "70px" }}>
        ...
        <ListItem button component={Link} to="/new-program">
          ...
          {isHovered && (
            <ListItemText primary="مشاهده برنامه" sx={{ color: "black" }} />
          )}
        </ListItem>
        <ListItem button component={Link} to="/new-program">
          <ListItemIcon
        ...
        <ListItem button component={Link} to="/test-results">
          ...
          {isHovered && (
            <ListItemText primary="نتایج تست‌ها" sx={{ color: "black" }} />
          )}
        </ListItem>
        <ListItem button component={Link} to="/analysis">
          ...
          {isHovered && (
            <ListItemText primary="آنالیز دوره" sx={{ color: "black" }} />
          )}
        </ListItem>
      ...
      <List sx={{ width: "100%", top: "6px" }}>
        <ListItem button component={Link} to="/messages">
          ...
          {isHovered && (
            <ListItemText primary="پیام‌ها" sx={{ color: "black" }} />
          )}
        </ListItem>
      </List>
      ...
      <div style={{ marginTop: "auto", marginBottom: "50px", width: "100%" }}>
        {userInfo && (
          <ListItem button onClick={logout}>
            ...
            {isHovered && (
              <ListItemText primary="خروج" sx={{ color: "black" }} />
            )}
          </ListItem>
        )}
      </div>
